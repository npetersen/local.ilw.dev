...
<?php do_action('woocommerce_email_header', 'Congratulations, you have a friend who cares about you and your health! Your friend has sent you a FREE 2015 membership to Team Intermountain LiVe Well!' ); ?>

<!-- <p><?php /* _e( 'This message is from', 'ignitewoo_gift_certs' ) */ ?><?php /* echo ' ' . $sitename; */ ?>!</p> -->

<p> <?php _e( 'Hi', 'ignitewoo_gift_certs' ); ?> <?php echo $recipient_name ?>, </p>

<?php echo $message; ?>

<p><?php _e( 'To redeem your free membership, add a <a href="http://teamintermountainlivewell.org/shop/2015-team-ilw-membership/">2015 Team ILW Membership</a> to your shopping cart and use the following coupon code during checkout:', 'ignitewoo_gift_certs' ); ?></p>
...
*/
	...
	if ( !empty( $voucher_expires ) ) {
		...
		<p><em>
			...
			<?php
				_e( 'Please note, this coupon code will expire on ', 'ignitewoo_gift_certs' );
